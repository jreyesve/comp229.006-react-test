...
function LoginForm() {
  ...
  const onSubmit = (data) => {
    ...
    alert(
      `Name: ${data.firstName}, Last Name: ${data.lastName}, User Name: ${data.userName}, Email: ${data.email}, Password: ${data.password}, Confirm Password: ${data.confirmPassword}`
    );

    console.log("Name: "+data.firstName+", Last Name: "+data.lastName+", User Name: "+data.userName+", Email: "+data.email+", Password: "+data.password+", Confirm Password:"+data.confirmPassword);
  };
